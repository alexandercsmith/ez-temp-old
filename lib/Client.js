 ...
 * @contructor
 * @param      {Object} config
 * @prop       {string} config.accessKeyId
 * @prop       {string} config.secretKeyId
 * @prop       {string} config.region
 * @prop       {string} config.apiVersion
 * @prop       {object} config.settings
 * @prop       {string} config.settings.table
 * @throws     {error}
 */
